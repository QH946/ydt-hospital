    ...
    <div class="nav left-nav">
      ...
      <div class="nav-item">
        <span
          ...
          :onclick="
            'javascript:window.location=\'/hospital/detail/' + hoscode + '\''
          "
        >
          医院详情
        </span>
      ...
      <div class="nav-item">
        <span
          class="v-link clickable dark"
          :onclick="
            'javascript:window.location=\'/hospital/notice/' + hoscode + '\''
          "
        >
          预约须知
        </span>
      ...
      <div class="hospital-source-list">
        ...
        <div class="mt60" v-if="tabShow">
          <div class="">
            ...
            <template v-for="item in scheduleList">
              <div :key="item.id" v-if="item.workTime == 0">
                <div class="list-item">
        ...
        <div class="mt60" v-if="tabShow">
          <div class="">
            ...
            <template v-for="item in scheduleList">
              <div :key="item.id" v-if="item.workTime == 1">
                <div class="list-item">
                  <div class="item-wrapper">
                    <div class="title-wrapper">
                      <div class="title">{{ item.title }}</div>
